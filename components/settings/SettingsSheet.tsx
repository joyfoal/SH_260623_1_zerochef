...
export function SettingsSheet({
  ...
  const handleAdd = () => {
    if (!newKey.trim().startsWith('sk-or-')) return
  ...
  const isValid = newKey.trim().startsWith('sk-or-') && newKey.trim().length > 20
                ...
                {view === 'main' ? (
                      ...
                      {envKeyConfigured && (
                        <div className="flex items-center gap-3 p-3.5 bg-green-950/30 border border-green-800/50 rounded-2xl mb-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-green-600 text-xs mt-0.5">OPENROUTER_API_KEY 환경변수를 읽고 있어요</p>
                          </div>
                        </div>
                      )}
                      ...
                      {!envKeyConfigured && keys.length === 0 ? (
                        <button onClick={() => setView('add')}
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-xs text-zinc-600">OpenRouter sk-or-... 키가 필요합니다</p>
                          </div>
                      ...
                      <div className="mt-3 bg-zinc-800/40 rounded-xl p-3.5 flex flex-col gap-2.5">
                        ...
                        <div className="border-t border-zinc-700 pt-2">
                          ...
                          <ol className="flex flex-col gap-1">
                            {['openrouter.ai 접속 후 로그인', 'Keys 메뉴 선택', 'Create Key', '위 "새 키 등록" 버튼으로 등록'].map((s, i) => (
                          ...
                          <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer"
                            ...
                            <ExternalLink className="w-3 h-3" />openrouter.ai/keys
                          </a>
                        </div>
                      </div>
                    </section>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      ...
                      {newKey && !isValid && (
                        <p className="text-amber-400 text-xs mt-1.5">sk-or- 로 시작하는 OpenRouter 키를 입력해주세요</p>
                      )}
                    </div>
